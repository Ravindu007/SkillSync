...
const UserLogin = () => {
  ...
  return (
    <div className='flex w-full h-full border-2 border-black'>
      ...
      <motion.div className="left hidden md:flex justify-center w-[50%]  h-full  border-2 border-black"
        variants={variants}
        initial='initial'
        whileInView='animate'
      >
      ...
      <div className="right w-[100%] md:w-[50%] h-full  border-2 border-blue-500">
        ...
        <div className="form-container h-full flex-col justify-center items-center border-2 border-red-200">
          <form action="" className='w-full h-full flex flex-col items-center justify-center gap-8'>
            ...
            <div className="w-full form-group px-1 md:px-5">
              <input type="text" className='input-item' placeholder='Password'/>
            </div>
